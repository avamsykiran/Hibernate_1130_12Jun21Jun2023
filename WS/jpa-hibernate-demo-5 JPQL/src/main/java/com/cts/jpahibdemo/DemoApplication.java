...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		TypedQuery<Trainee> q2 = em.createQuery("SELECT t FROM Trainee t", Trainee.class);
		...
		TypedQuery<Employee> q5 = em.createQuery(
				String.format("SELECT e FROM Employee e WHERE e.gender='%s'", Gender.GENT), Employee.class);
		...
		TypedQuery<DeptWiseEmpCount> q8 = em.createQuery(
